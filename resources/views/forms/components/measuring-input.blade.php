...
>
    ...
    >
        <div class="flex items-center space-x-2">
            <template x-for="(star, index) in measures" :key="index">
                <button type="button"
                        @click="rate(index + 1);"
                        @mouseover="hoverMeasure = index + 1"
                        @mouseleave="hoverMeasure = state"
                        aria-hidden="true"
                        @class([
                            match ($color) {
            ...
            <template x-for="(star, index) in remaining" :key="index">
                <button type="button"
                        ...
                        @mouseover="hoverMeasure = measures + index + 1"
                        @mouseleave="hoverMeasure = measures"
                        aria-hidden="true"
