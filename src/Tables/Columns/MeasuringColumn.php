...
namespace Lartisan\MeasuringTools\Tables\Columns;
...
class MeasuringColumn extends Column
{
    ...
    protected string $view = 'filament-measuring-tools::tables.columns.measuring-column';
