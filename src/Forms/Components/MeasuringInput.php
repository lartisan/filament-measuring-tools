...
namespace Lartisan\MeasuringTools\Forms\Components;
...
class MeasuringInput extends Field
{
    ...
    protected string $view = 'filament-measuring-tools::forms.components.measuring-input';
