...
namespace Lartisan\MeasuringTools\Infolists\Components;
...
class MeasuringEntry extends Entry
{
    ...
    protected string $view = 'filament-measuring-tools::infolists.components.measuring-entry';
